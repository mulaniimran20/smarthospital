...
<html <?php //echo $this->customlib->getRTL();     ?>>
    <head>
        ...
        <link href="<?php echo base_url(); ?>uploads/hospital_content/logo/logo_short1.png" rel="shortcut icon" type="image/x-icon">
    ...
    <body class="hold-transition skin-blue fixed sidebar-mini" >
        ...
        if (!empty($logoresult["image"])) {
            ...
            $logo_image = base_url() . "uploads/hospital_content/logo/logo_full1.png";
        }
        if (!empty($logoresult["mini_logo"])) {
            $mini_logo = base_url() . "uploads/hospital_content/logo/" . $logoresult["mini_logo"];
        } else {
            $mini_logo = base_url() . "uploads/hospital_content/logo/logo_short1.png";
        }
        ?>
        <div class="wrapper">
            <header class="main-header" id="alert">            
                <a href="<?php echo base_url(); ?>admin/admin/dashboard" class="logo">                 
                    <span class="logo-mini"><img width="40" height="30" src="<?php echo $mini_logo; ?>" alt="<?php echo $this->customlib->getAppName() ?>" /></span>                 
                    <span class="logo-lg"><img src="<?php echo $logo_image; ?>" alt="<?php echo $this->customlib->getAppName() ?>" style="height:50px;" /></span>
                </a>             
