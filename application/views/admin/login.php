...
<html lang="en">
    <head>
        ...
        <!--favican-->
        <link href="<?php echo base_url(); ?>uploads/hospital_content/logo/s-logo_short1.png" rel="shortcut icon" type="image/x-icon">
        <!-- CSS -->
                            ...
                            <div class="loginbg">  
                                <div class="form-top">
                                    ...
                                    <div class="form-top-left">
                                        <img src="<?php echo $logo_image; ?>" style="height: 100px; width: 150px;">    
                                    </div>
